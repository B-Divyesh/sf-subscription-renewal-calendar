# Subscription Renewal Calendar (`subscription-renewal-calendar`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://subscription-renewal-calendar.sociobot.in`. Artifact class: `pwa-offline`.
